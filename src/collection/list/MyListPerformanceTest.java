...
public class MyListPerformanceTest {
    ...
    private static void search(MyList<Integer> list, int loop, int findeValue) {
        long startTime = System.currentTimeMillis();
        for (int i = 0; i < loop; i++) {
            list.indexOf(findeValue);
        }
        long endTime = System.currentTimeMillis();
        System.out.println("findeValue : " + findeValue + ", 반복 : " + loop + ", 계산 시간 : " + (endTime - startTime) + "ms");
    }
}
